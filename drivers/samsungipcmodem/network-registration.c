				...
				ofono_netreg_operator_list_cb_t cb, void *data)
{
	...
	if (ipc_device_enqueue_message(nd->device, IPC_NET_PLMN_LIST,
				       IPC_TYPE_GET, NULL, 0,
				       list_operators_cb, cbd) > 0)
		return;
				...
				ofono_netreg_register_cb_t cb, void *data)
{
	...
	if (ipc_device_enqueue_message(nd->device, IPC_NET_PLMN_SEL,
				IPC_TYPE_SET, req,
				...
				ofono_netreg_operator_cb_t cb, void *data)
{
	...
	if (ipc_device_enqueue_message(nd->device, IPC_NET_SERVING_NETWORK,
				       IPC_TYPE_GET, NULL, 0,
				       current_operator_cb, cbd) > 0)
		return;
					...
					void *data)
{
	...
	if (ipc_device_enqueue_message(nd->device, IPC_NET_REGIST,
				IPC_TYPE_GET, req,
